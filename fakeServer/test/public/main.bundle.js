...
var TaskBuilder = (function () {
    ...
    TaskBuilder.prototype.build = function () {
        return new __WEBPACK_IMPORTED_MODULE_0__Task__["a" /* Task */](this.title, this.date, this.priority, this.isDone);
    };
    return TaskBuilder;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs___ = __webpack_require__(865);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__accessoryClasses_task_TaskBuilder__ = __webpack_require__(1130);
...
var TasksStore = (function () {
    ...
    TasksStore.prototype.getTasks = function (amount) {
        var _this = this;
        var getURL = "/tasks/recent/" + { amount: amount };
    ...
    TasksStore.prototype.addTask = function (task) {
        ...
        this.http.post(addURL, {
            ...
            var doneJSON = _this.extractData(val); //JSON that have only one fiel isDone, true if task was added on the server side
            readyStateSubj$.next(doneJSON['isAdded']);
        });
...
var AppComponent = (function () {
    ...
    AppComponent = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["R" /* Component */])({
            ...
            styles: [__webpack_require__(854), __webpack_require__(857)],
...
var AppTasksComponent = (function () {
    ...
    AppTasksComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.taskManagerService.getTasks().subscribe(function (task) {
