...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__accessoryClasses_task_TasksArrAsync__ = __webpack_require__(783);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__TasksStore__ = __webpack_require__(468);
...
var TaskManagerService = (function () {
    function TaskManagerService(tasksStore) {
        ...
        this.taskArr = new __WEBPACK_IMPORTED_MODULE_1__accessoryClasses_task_TasksArrAsync__["a" /* TasksArrAsync */]();
        this.tasksStore.getTasks(this.Defaults_Loaded_Tasks_Amount)
            .subscribe(function (task) {
            _this.taskArr.push(task);
        });
    }
    ...
    TaskManagerService.prototype.delTask = function (task) {
        ...
        this.tasksStore.delTask(task).subscribe(function (res) {
            if (res)
                _this.taskArr.remove(task);
        });
    };
    TaskManagerService = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["c" /* Injectable */])(), 
        __metadata('design:paramtypes', [(typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__TasksStore__["a" /* TasksStore */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_2__TasksStore__["a" /* TasksStore */]) === 'function' && _a) || Object])
    ], TaskManagerService);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs___ = __webpack_require__(591);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__accessoryClasses_task_TaskBuilder__ = __webpack_require__(782);
...
var TasksStore = (function () {
    ...
    TasksStore.prototype.getTasks = function (amount) {
        ...
        console.log('hi');
        var amountSubj$ = new __WEBPACK_IMPORTED_MODULE_2_rxjs___["Subject"]();
        this.http.get(getURL).subscribe(function (val) {
            var tasks = _this.extractData(val);
            for (var _i = 0, tasks_1 = tasks; _i < tasks_1.length; _i++) {
                var task = tasks_1[_i];
                amountSubj$.next(_this.convertJSONTask(task));
            }
        });
        return amountSubj$;
    };
    //postone task for amount of days as a optional parameter, default 1 day
    TasksStore.prototype.postponeTask = function (task, daysAmount) {
        var _this = this;
        if (!daysAmount) {
            daysAmount = 1;
        }
        ...
        this.http.get(postponeURL).subscribe(function (resp) {
            postoneSubj$.next(_this.extractData(resp)['isPostponed']);
        });
        return postoneSubj$;
    };
    ...
    TasksStore.prototype.convertJSONTask = function (task) {
    ...
    TasksStore.prototype.extractData = function (res) {
        var body = res.json();
        return body || {};
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__environments_environment__ = __webpack_require__(791);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__app_app_module__ = __webpack_require__(785);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Task__ = __webpack_require__(261);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_rxjs___ = __webpack_require__(591);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_rxjs____default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_rxjs___);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return TasksArrAsync; });
...
var TasksArrAsync = (function () {
    function TasksArrAsync() {
        this.tasks = [];
        this.changeSream = new __WEBPACK_IMPORTED_MODULE_0_rxjs___["Subject"]();
    }
...
//# sourceMappingURL=E:/progects/New folder/todolist/src/TasksArrAsync.js.map
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_login_component_app_loginComponent__ = __webpack_require__(787);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_http__ = __webpack_require__(99);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ng_bootstrap_ng_bootstrap__ = __webpack_require__(779);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_main_component_app_root_rootcomponent__ = __webpack_require__(788);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__app_login_module__ = __webpack_require__(784);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__angular_material__ = __webpack_require__(384);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_hammerjs__ = __webpack_require__(846);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_hammerjs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8_hammerjs__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_header_component_app_header__ = __webpack_require__(786);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_task_component_tasks_app_tasks__ = __webpack_require__(789);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_task_component_tasks_task_app_task__ = __webpack_require__(790);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_mydatepicker__ = __webpack_require__(853);
...
var AppComponent = (function () {
    ...
    AppComponent = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["R" /* Component */])({
            ...
            styles: [__webpack_require__(857), __webpack_require__(860)],
...
module.exports = "\r\n<app-task *ngFor=\"let task of tasksArrAsync.getTasks()\" [task]=\"task\" (delTask)=\"delTask(task)\"></app-task>\r\n"
